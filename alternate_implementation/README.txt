...
The file that should ideally be used is main.py, but since we don't have a working model
yet, main_nomodel.py will suffice. It's just that segmenting an image will use a default
image (see sample_segimg.png). This means that the use of main_nomodel.py is merely just
for demonstration purposes. The default image is an incomplete, and definitely a wrong 
segmentation of SoPIA_20221017/Aggregates/Project 2 Images/Amiterra-112620/IMG_14488.png.
