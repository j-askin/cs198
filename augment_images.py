...
train_count = 5
val_count = 5
data_dir="data/sopia_xpl"   # relative/path/to/folder
out_dir="sopia_aug"         # desired output folder

# It is recommended to put this file in the same level as the folder of the images for the program to work
