...
class Grid(qtw.QMainWindow):
    ...
    def create_grid(self):
        ...
        self.parent().gridLabel = qtw.QLabel()
        self.parent().gridLabel.setGeometry(0,0,x,y)
        self.parent().gridLabel.setPixmap(gridimg)
        self.parent().gridLabel.setAlignment(Qt.AlignmentFlag(1))
        self.parent().gridLabel.show()
        self.parent().scene.addWidget(self.parent().gridLabel)
        self.parent().gridLabel.setAutoFillBackground(False)
