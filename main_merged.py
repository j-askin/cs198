...
class UI(qtw.QMainWindow):
    ...
    cfg, mdl, pth = "", "", ""
    t_buttonstate = [True,True,True,True,True,True,True]
    ...
    color_select = 0
    mode = 0 #normal for 0, alternate for 1
    def __init__(self):
    ...
    def lock_ui(self):
        self.t_buttonstate = [self.loadImage.isEnabled(),self.loadModel.isEnabled(),self.segmentImage.isEnabled(),self.getPoints.isEnabled(),self.selectBorder.isEnabled(),self.selectGrid.isEnabled(),self.confirmGrid.isEnabled(),self.createGrid.isEnabled(),self.changeMode.isEnabled()]
    ...
    def unlock_ui(self):
        ...
        self.confirmGrid.setEnabled(self.t_buttonstate[6])
        self.createGrid.setEnabled(self.t_buttonstate[7])
        self.changeMode.setEnabled(self.t_buttonstate[7])
    ...
    def change_mode(self):
        self.lock_ui()
        self.mode = self.changeMode.isChecked()
